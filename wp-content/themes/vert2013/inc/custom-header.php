...
?>
	...
	.appearance_page_custom-header #headimg {
		...
		<?php
		if ( ! empty( $header_image ) ) {
			echo 'background: url(' . esc_url( $header_image ) . ') no-repeat scroll top; background-size: auto 1600px;';
		} ?>
		padding: 20px 0;
	}
	#headimg .home-link {
...
function twentythirteen_admin_header_image() {
	...
	?>
	<div id="headimg" style="background: url(<?php echo esc_url( get_header_image() ); ?>) no-repeat scroll top; background-size: auto 1600px;">
		<div class="home-link">
