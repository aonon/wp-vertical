...
function twentythirteen_setup() {
	 ...
	 */
	add_editor_style( array( 'normalize', 'css/editor-style.css', 'genericons/genericons.css') );
	...
	set_post_thumbnail_size( 270, 604, true );
...
function twentythirteen_scripts_styles() {
	...
	wp_enqueue_style( 'twentythirteen-style', get_stylesheet_uri(),  array('normalize'), '2013-07-18' );
