...
function dazzling_customizer( $wp_customize ) {
    ...
    $wp_customize->add_panel('dazzling_main_options', array(
        ...
        $wp_customize->add_section('dazzling_layout_options', array(
            ...
            $wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, 'dazzling[element_color]', array(
            ...
            $wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, 'dazzling[element_color_hover]', array(
        ...
        $wp_customize->add_section('dazzling_action_options', array(
            ...
            $wp_customize->add_control('dazzling[w2f_cfa_text]', array(
                ...
                'description' => sprintf(__('Enter the text for call for action section', 'dazzling')),
            ...
            $wp_customize->add_control('dazzling[w2f_cfa_button]', array(
            ...
            $wp_customize->add_control('dazzling[w2f_cfa_link]', array(
                'label' => __('CFA button link', 'dazzling'),
                'section' => 'dazzling_action_options',
        ...
        $wp_customize->add_section('dazzling_social_options', array(
            ...
            $wp_customize->add_setting('dazzling[social_color]', array(
                'default' => '',
                'type'  => 'option',
                'sanitize_callback' => 'dazzling_sanitize_hexcolor'
            ));
            ...
            $wp_customize->add_control('dazzling[footer_social]', array(
                'label' => __('Footer Social Icons', 'dazzling'),
                'description' => sprintf(__('Check to show social icons in footer', 'dazzling')),
                'section' => 'dazzling_social_options',
                'type' => 'checkbox',
            ));
...
function dazzling_customizer_custom_control_css() {
	?>
    <style>
        #customize-control-dazzling-main_body_typography-size select, #customize-control-dazzling-main_body_typography-face select,#customize-control-dazzling-main_body_typography-style select { height: 60%; }
    </style><?php
}
