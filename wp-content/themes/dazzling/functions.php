...
function dazzling_scripts() {
  ...
  wp_enqueue_style( 'dazzling-bootstrap', 'http://mongol-bichig.top/bs3/css/bootstrap.min.css' );
  ...
  wp_enqueue_style( 'dazzling-style', get_stylesheet_uri(),  array('normalize') );

  wp_enqueue_script('dazzling-bootstrapjs', 'http://mongol-bichig.top/bs3/js/bootstrap.min.js', array('jquery') );
...
$typography_options = array(
        ...
        'faces' => array(
                'arial'          => 'chagan,syrga,sans-serif',
                'verdana'        => 'urga,Geneva,sans-serif',
                'trebuchet'      => 'uraga,syrga,sans-serif',
                'georgia'        => 'chagan,serif',
                'times'          => 'urga,syurga, serif',
                'tahoma'         => 'bichimel,Geneva,sans-serif',
                'Open Sans'      => 'chagan,sans-serif',
                'palatino'       => 'urga,serif',
                'helvetica'      => 'syrga,chagan,sans-serif',
                'helvetica-neue' => 'urga, syrga ,chagan,sans-serif'
        ),
