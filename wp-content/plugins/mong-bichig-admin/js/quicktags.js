...
(function(){
	...
	qt = QTags = function(settings) {
		...
		onclick = function(e) {
			e = e || window.event;
			var target = e.target || e.srcElement, visible = target.clientHeight || target.offsetHeight, i;
	...
	qt.insertContent = function(content) {
		var sel, startPos, endPos, scrollLeft, text, canvas = document.getElementById(wpActiveEditor);
	...
	qt.TagButton.prototype.callback = function(element, canvas, ed) {
		var t = this, startPos, endPos, cursorPos, scrollLeft, v = canvas.value, l, r, i, sel, endTag = v ? t.tagEnd : '';
		...
		if ( document.selection ) { // IE
			...
			cursorPos = endPos;
			scrollLeft = canvas.scrollLeft;
			l = v.substring(0, startPos); // top of the selection
			r = v.substring(endPos, v.length); // bottom of the selection
