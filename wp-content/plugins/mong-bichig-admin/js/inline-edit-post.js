...
inlineEditPost = {
	...
	setBulk : function(){
		...
		// Insert the editor at the left of the table with an empty row above to maintain zebra striping.
		...
		if ( locked.hasOwnProperty( key ) ) {
			if ( ! row.hasClass('wp-locked') ) {
				...
				if ( lock_data.avatar_src ) {
					avatar = $( '<img class="avatar avatar-18 photo" height="18" width="18" alt="" />' ).attr( 'src', lock_data.avatar_src.replace( /&amp;/g, '&' ) );
