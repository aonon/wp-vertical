...
( function() {
	...
	main[lang] = {
		...
		directionality: {
			ltr_desc: "Direction top to bottom",
			rtl_desc: "Direction bottom to top"
		},
		layer: {
	...
	tinyMCE.addI18n( lang + ".advanced", {
		...
		justifyleft_desc: "Align Top (Alt + Shift + L)",
		justifycenter_desc: "Align Center (Alt + Shift + C)",
		justifyright_desc: "Align Bottom (Alt + Shift + R)",
	...
	tinyMCE.addI18n( lang + ".advanced_dlg", {
		...
		charmap_usage: "Use top and bottom arrows to navigate.",
		...
		image_align_top: "Left",
		image_align_middle: "Middle",
		image_align_bottom: "Right",
		image_align_texttop: "Text left",
		image_align_textbottom: "Text right",
		image_align_left: "Top",
		image_align_right: "Bottom",
	...
	tinyMCE.addI18n( lang + ".media_dlg", {
		...
		align_left: "Top",
		align_center: "Center",
		align_top_left: "Left top",
		align_top_right: "Left bottom",
		align_bottom_left: "Right top",
		align_bottom_right: "Right bottom",
