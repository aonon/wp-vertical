...
var tinyMCEPopup = {
	...
	getWin: function() {
		...
		return (!window.frameElement && window.dialogArguments) || opener || parent || left;
	},
...
tinymce.util.Dispatcher = function(scope) {
	...
	this.addToLeft = function(callback, scope) {
		var self = this, listener = {cb : callback, scope : scope || self.scope};

		// Create new listeners if addToLeft is executed in a dispatch loop
		if (self.inDispatch) {
